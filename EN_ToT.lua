...
function ETT_TargetTargetFrame_OnUpdate(self, elapsed)
    ETT_TargetTargetFrameName:SetText(UnitName("targettarget"));
        ...
        --DEBUG
        --print("EN_ToT.lua, UnitPowerType: "..tostring(UnitPowerType("targettarget")));
    ...
    if UnitPowerMax("targettarget") == 0 then
        ...
        ETT_TargetTargetFrameManaBar:SetValue(UnitPower("targettarget") / UnitPowerMax("targettarget") * 100);
    end;
end
...
function ETT_TargetTargetTargetFrame_OnUpdate(self, elapsed)
    ETT_TargetTargetTargetFrameName:SetText(UnitName("targettargettarget"));
        ...
        --DEBUG
        --print("EN_ToT.lua, UnitPowerType: "..tostring(UnitPowerType("targettargettarget")));
    ...
    if UnitPowerMax("targettargettarget") == 0 then
        ...
        ETT_TargetTargetTargetFrameManaBar:SetValue(UnitPower("targettargettarget") / UnitPowerMax("targettargettarget") * 100);
    end;
end
